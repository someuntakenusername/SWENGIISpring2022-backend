...
public class YelpService {
    ...
    public String RecAlgorithm(int cost, String rating, String reviews, String contact, String location) throws IOException {
        ...
        URL url = new URL("http://127.0.0.1:29237/http://api.yelp.com/v3/businesses/search?categories=skiresorts&location=" + location + "&limit=50&sort_by=best_match");
        return getYelpQuery(url);
    }

    public String getById(String id) throws IOException {
        URL url = new URL("http://127.0.0.1:29237/http://api.yelp.com/v3/businesses/" + id);
        return getYelpQuery(url);
    }
